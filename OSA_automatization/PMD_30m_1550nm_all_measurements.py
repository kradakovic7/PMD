...
# User Settings
# ----------------------
MEASUREMENT_FOLDER = r'PMD_Spectra_30m_1550nm' 

# Path to the ONE Reference file (Green Trace)
REFERENCE_FILE     = r'PMD_Spectra_1550nm_reference/3.csv'

# Output folder for images and table
OUTPUT_FOLDER      = r'test_30m_1550nm'

fiber_length_km = 0.03

# Range
START_WAVELENGTH = 1595.0
STOP_WAVELENGTH  = 1720.0
