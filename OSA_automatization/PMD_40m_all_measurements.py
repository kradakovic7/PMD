...
# User Settings
# ----------------------
MEASUREMENT_FOLDER = r'PMD_Spectra_40m' 

# Path to the ONE Reference file (Green Trace)
REFERENCE_FILE     = r'PMD_Spectra_40m_reference/1.csv'

# Output folder for images and table
OUTPUT_FOLDER      = r'test_40m'

fiber_length_km = 0.04

# Range
START_WAVELENGTH = 1240.0
STOP_WAVELENGTH  = 1400.0
