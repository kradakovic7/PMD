...
# User Settings
# ------------------
csv_file = 'spectra_csv\spectrum_01_20250723_1325.csv'  # Path to your CSV
lambda_min = 1580.0       # nm
lambda_max = 1710.0       # nm
fiber_length_km = 0.01    # fiber length [km]
threshold_db = 20.0         # dB above noise
...
# Smooth Data
# ------------------
int_smooth = savgol_filter(intensities, window_length=4, polyorder=2)
