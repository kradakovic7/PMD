...
print(f"Input Resistor (Rin): {R_in_standard:.0f} Ohms (Chosen)")
print(f"Integral Capacitor (Ci): {C_i_standard*1e6:.0f} uF (Chosen)")
print(f"Feedback Resistor (Rf) for Kp: {R_f_pi:.0f} Ohms")
print(f"Integral Resistor (Ri) for Ti: {R_i_pi:.0f} Ohms")